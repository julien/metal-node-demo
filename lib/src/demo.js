...
exports.createJSXComponent = createJSXComponent;
...
function createJSXComponent() {
  _metalJsx.JSXComponent.render(iDOMHelpers.jsxWrapper(function () {
    return IncrementalDOM.elementVoid(DemoJSXComponent, null, null, "message", "Hello MetalJS!");
  }));
};